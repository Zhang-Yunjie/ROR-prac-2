...
class SemestersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create semester" do
    assert_difference('Semester.count') do
      post semesters_url, params: { semester: { ay: @semester.ay, past: @semester.past, sem: @semester.sem } }
    end
  ...
  test "should update semester" do
    patch semester_url(@semester), params: { semester: { ay: @semester.ay, past: @semester.past, sem: @semester.sem } }
